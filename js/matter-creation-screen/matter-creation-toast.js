...
<div class="d-flex">
  ...
  <button type="button" class="btn-close btn-close-white me-2 m-auto" onclick="$('#matter-creation-toast').toggle();" data-bs-dismiss="toast" aria-label="Close"></button>
</div>
</div>`
...
function showMatterToast(){
    $('#matter-creation-toast').toggle();//showing matter created toast
    setTimeout(() => {
    $('#matter-creation-toast').toggle();//hiding matter created toast on timeout
    }, 3000);
}